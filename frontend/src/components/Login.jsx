  ...
  return (
    <div className='w-screen h-screen items-start flex justify-center'>
      <div className='bg-white shadow-md shadow-slate-300 w-[30%] my-10 h-auto p-7'>
        ...
        <h2 className='inter-login-text text-gray-600 text-4xl'>Login</h2>
        <form action="" method="post" className='mt-8 flex flex-col '>
            <label htmlFor="" className='text-[14px] text-zinc-500'>Username</label>
            <input type="text" name="username" id="username" className=' p-2 mt-1 mb-4 shadow-md shadow-zinc-200 hover:outline-zinc-600 outline-none rounded-md' placeholder='Rakesh Roushan'/>
            ...
            <button className='bg-[#1C212C] hover:bg-[#252B38] text-white p-2 mt-7 rounded-md'>Login</button>
            <div className='flex items-center gap-1 justify-center my-3'>
                <p className='text-zinc-500'>Dont' have an acoount yet?</p>
                <a href="#" target="_blank" className='underline'>Create one</a>
            </div>
        </form>
